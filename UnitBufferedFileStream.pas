unit UnitBufferedFileStream;

// модуль взят у David Heffernan здесь https://stackoverflow.com/questions/5639531/buffered-files-for-faster-disk-access
// На данный момент в Delphi 10.1 существует аналогичный класс TBufferedFileStream
